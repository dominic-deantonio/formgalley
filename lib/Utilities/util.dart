...
class Util {
  static String formatDisplayDate(DateTime dt) {
    String result;
    try {
      result = DateFormat('d MMMM yyyy').format(dt).toString();
    } catch (e) {
      print('Failed to parse $dt');
    }
    return result;
  }

  static String getStringStorageFormatFromDate(DateTime dt) {
    var dateFormat = DateFormat('yyyyMMddHHmmss').format(dt);
    return dateFormat.toString();
  }

  static DateTime getDateFromStringStorageFormat(String input) {
